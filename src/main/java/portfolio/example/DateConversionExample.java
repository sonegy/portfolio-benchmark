...
public class DateConversionExample {
    ...
    public static void main(String[] args) {
        ...
        long period1 = DateUtils.toUnixTimestamp(date);
        ...
        long period2 = DateUtils.toUnixTimestamp(dateString);
        ...
        long thirtyDaysAgo = DateUtils.daysAgoUnixTimestamp(30);
        ...
        long period3 = DateUtils.toUnixTimestamp(dateTime);
        ...
        System.out.println("long period1 = DateUtils.toUnixTimestamp(\"2024-07-06\"); // " + DateUtils.toUnixTimestamp("2024-07-06"));
        System.out.println("long period2 = DateUtils.toUnixTimestamp(\"2024-07-08\"); // " + DateUtils.toUnixTimestamp("2024-07-08"));
        ...
        System.out.println("long period1 = DateUtils.daysAgoUnixTimestamp(30); // " + DateUtils.daysAgoUnixTimestamp(30));
        System.out.println("long period2 = DateUtils.todayUnixTimestamp(); // " + DateUtils.todayUnixTimestamp());
        System.out.println("ChartResponse response = fetcher.fetchHistory(\"AAPL\", period1, period2);");
    }
}
