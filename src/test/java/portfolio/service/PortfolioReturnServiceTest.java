...
class PortfolioReturnServiceTest {
    ...
    void shouldReturnPortfolioReturnDataForValidRequest() {
        ...
        ChartResponse mockResponse1 = createMockChartResponse();
        ChartResponse mockResponse2 = createMockChartResponse();
        Map<String, ChartResponse> stockData = new HashMap<>();
        stockData.put("AAPL", mockResponse1);
        stockData.put("GOOGL", mockResponse2);
